        ...
        <div className="column intro__container blur-effect">
          <div className="header__info">
            <div className="header__info__top">
              Hello There! I'm <span className="color__primary">Shubam Choudhary</span>
            </div>
            <div className="header__info__middle">
              ...
              "I transform complex user needs into seamless digital experiences that combine innovation, functionality, and elegance."              </p>
            </div>
