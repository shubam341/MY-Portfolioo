        ...
        <section id="about">
            <div className="section__wrapper about__container">
                ...
                <div className="section__header">
                    ...
                    <h1 className="title">I am <span className="color__primary">Shubam Choudhary</span></h1>
                    <p className="text__muted description">
                        Experienced Full Stack Developer with a passion for creating dynamic, intuitive, responsive applications. 
